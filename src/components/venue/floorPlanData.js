...
export const GROUND_FLOOR_ROOMS = [
  ...
  },
  {
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 480, y: 320, width: 120, height: 90 },
  },
  {
    id: 'library',
    name: 'Library',
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 480, y: 180, width: 100, height: 80 },
  },
  {
    id: 'cafeteria',
    name: 'Cafeteria',
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 620, y: 420, width: 140, height: 130 },
  },
  {
    id: 'kitchen',
    name: 'Kitchen',
    ...
    workshopTrack: null,
    isEventRoom: false,
    coordinates: { x: 690, y: 350, width: 90, height: 60 },
  },
  {
    id: 'music-room',
    name: 'Music Room',
    ...
    workshopTrack: null,
    isEventRoom: false,
    coordinates: { x: 690, y: 240, width: 90, height: 100 },
  },
  {
    id: 'stairs-gf',
    name: 'Stairs',
    fullName: 'Stairs to Upper Floors',
    type: ROOM_TYPES.UTILITY,
    floor: FLOORS.GROUND,
    capacity: 0,
    ...
    workshopTrack: null,
    isEventRoom: false,
    coordinates: { x: 370, y: 430, width: 80, height: 70 },
  },
  {
    id: 'counseling-room',
  ...
  },
  {
    ...
    workshopTrack: null,
    isEventRoom: false,
    coordinates: { x: 610, y: 140, width: 80, height: 80 },
  },
  {
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 80, y: 480, width: 100, height: 70 },
  },
  {
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 50, y: 410, width: 60, height: 60 },
  },
  {
    id: 'male-restroom-gf',
    name: 'Male CR',
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 120, y: 380, width: 60, height: 60 },
  },
  {
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 600, y: 270, width: 60, height: 60 },
  },
  {
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 700, y: 160, width: 60, height: 60 },
  },
  {
    id: 'exit-main-gf',
    name: 'EXIT',
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 710, y: 450, width: 70, height: 30 },
  },
  {
    id: 'exit-entrance-gf',
    name: 'EXIT',
