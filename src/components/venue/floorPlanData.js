...
export const GROUND_FLOOR_ROOMS = [
  {
    ...
    workshopTrack: 'Women',
    isEventRoom: true,
    coordinates: { x: 280, y: 380, width: 140, height: 100 },
  },
  {
    id: 'sen-gg-room',
    name: 'SEN/GG Room',
    ...
    isEventRoom: true,
    coordinates: { x: 280, y: 490, width: 140, height: 90 },
  },
  {
    id: 'youth-center',
    name: 'Youth Center',
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 580, y: 330, width: 120, height: 85 },
  },
  {
    id: 'library',
    name: 'Library',
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 580, y: 150, width: 100, height: 75 },
  },
  {
    id: 'cafeteria',
    name: 'Cafeteria',
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 580, y: 450, width: 120, height: 130 },
  },
  {
    id: 'kitchen',
    name: 'Kitchen',
    ...
    workshopTrack: null,
    isEventRoom: false,
    coordinates: { x: 710, y: 350, width: 70, height: 90 },
  },
  {
    id: 'music-room',
    name: 'Music Room',
    ...
    workshopTrack: null,
    isEventRoom: false,
    coordinates: { x: 710, y: 240, width: 70, height: 100 },
  },
  {
    id: 'counseling-room',
  ...
  },
  {
    ...
    workshopTrack: null,
    isEventRoom: true,
    coordinates: { x: 50, y: 520, width: 100, height: 60 },
  },
  {
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 30, y: 460, width: 70, height: 50 },
  },
  {
    id: 'male-restroom-gf',
    name: 'Male CR',
    ...
    isEventRoom: false,
    alwaysShow: true,
    coordinates: { x: 100, y: 390, width: 70, height: 60 },
  },
  {
    id: 'exit-main-gf',
    name: 'EXIT',
