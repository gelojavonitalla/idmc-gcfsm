...
import { ROUTES, CONTACT, SOCIAL_LINKS, CONFERENCE } from '../../constants';
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.brand}>
            <h3 className={styles.brandTitle}>IDMC {CONFERENCE.YEAR}</h3>
            <p className={styles.brandTagline}>{CONFERENCE.TAGLINE}</p>
