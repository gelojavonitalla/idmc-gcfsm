...
function RegistrationDetailModal({
  ...
  const [useAutoGeneratedMessage, setUseAutoGeneratedMessage] = useState(false);
                    ...
                    {amountPaid > 0 && amountPaid < registration.totalAmount && (
                      <div className={styles.formGroup}>
                        ...
                        <div className={styles.checkboxRow}>
                          <input
                            type="checkbox"
                            id="useAutoGeneratedMessage"
                            checked={useAutoGeneratedMessage}
                            onChange={(e) => {
                              const checked = e.target.checked;
                              setUseAutoGeneratedMessage(checked);
                              if (checked) {
                                const autoMessage = `Partial payment of ₱${amountPaid} received. Please upload proof of remaining ₱${(registration.totalAmount - amountPaid).toFixed(2)}`;
                                setRejectionReason(autoMessage);
                              }
                            }}
                          ...
                          />
                          <label
                            htmlFor="useAutoGeneratedMessage"
                        ...
                        <textarea
                          ...
                          onChange={(e) => {
                            ...
                            if (useAutoGeneratedMessage) {
                              setUseAutoGeneratedMessage(false);
                            }
                          }}
