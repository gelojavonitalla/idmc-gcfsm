...
function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    /**
     * Fetches privacy policy content from settings
     */
  ...
  const getSectionContent = (sectionId) => {
    ...
    const section = privacyData.sections.find((s) => s.id === sectionId);
  ...
  const lastUpdated = privacyData?.lastUpdated || fallbackLastUpdated;
        ...
        <div className="container">
          <div className={styles.contentWrapper}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('introduction') ? (
                formatContent(getSectionContent('introduction'))
              ) : (
                <>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('information-collected') ? (
                formatContent(getSectionContent('information-collected'))
              ) : (
                <>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('information-use') ? (
                formatContent(getSectionContent('information-use'))
              ) : (
                <>
                  <p className={styles.text}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('data-storage') ? (
                formatContent(getSectionContent('data-storage'))
              ) : (
                <>
                  <p className={styles.text}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('data-sharing') ? (
                formatContent(getSectionContent('data-sharing'))
              ) : (
                <>
                  <p className={styles.text}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('data-retention') ? (
                formatContent(getSectionContent('data-retention'))
              ) : (
                <>
                  <p className={styles.text}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('your-rights') ? (
                formatContent(getSectionContent('your-rights'))
              ) : (
                <>
                  <p className={styles.text}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('cookies') ? (
                formatContent(getSectionContent('cookies'))
              ) : (
                <>
                  <p className={styles.text}>
            ...
            <div className={styles.section}>
              ...
              {hasCustomContent('children') ? (
                formatContent(getSectionContent('children'))
              ) : (
                <p className={styles.text}>
